        ...
        <header>
            ...
            <div class="canto-header">
                ...
                <div class="login-header">
                    <a href="./<%= session.getAttribute("userId") != null ? "conta" : "login"%>.jsp"><img src="https://cdn1.iconfinder.com/data/icons/freeline/32/account_friend_human_man_member_person_profile_user_users-512.png" width="20" style="vertical-align: middle"></a>
                </div>
                <!-- Carrinho -->
