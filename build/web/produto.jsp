...
<main class="container">
  ...
  <div class="right-column">
    ...
    <div class="rate">
      <input onClick="window.location.href='avaliacao.jsp'" type="radio" id="star5" name="rate" value="5" />
      <label for="star5" title="text"></label>
      <input onClick="window.location.href='avaliacao.jsp'" type="radio" id="star4" name="rate" value="4" />
      <label for="star4" title="text"></label>
      <input onClick="window.location.href='avaliacao.jsp'" type="radio" id="star3" name="rate" value="3" />
      <label for="star3" title="text"></label>
      <input onClick="window.location.href='avaliacao.jsp'" type="radio" id="star2" name="rate" value="2" />
      <label for="star2" title="text"></label>
      <input onClick="window.location.href='avaliacao.jsp'" type="radio" id="star1" name="rate" value="1" />
...
<div class="product-rating">
  ...
  <div class="right-rating">
    ...
    <div class="review-btn">
      <a href="avaliacao.jsp">Adicionar uma avaliação</a>
    </div>
  </div>
</div>
