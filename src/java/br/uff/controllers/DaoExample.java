 ...
 * @author HP
 */
@WebServlet(name = "DaoExample", urlPatterns = {"/DaoExample"})
public class DaoExample extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                String[] bind = {"2"};
                String ret = db.dbValor("name", "roles", "id=?", bind);
                out.println(ret);

                out.println("<br>");

                try {
                    String[] bindGrava = {"TESTE"};
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DaoExample.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
